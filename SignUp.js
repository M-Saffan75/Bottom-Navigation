    ...
    <SafeAreaView>
      ...
      <View styles={{ backgroundColor: '#fff' }}>
        ...
        <View>
          ...
          <Text style={{ fontSize: 20, fontFamily: 'Poppins-Bold', marginLeft: 20, letterSpacing: 1, color: 'grey', }}>Sign Up </Text>

          <TextInput type='text' placeholder='Name' style={styles.myEmail} placeholderTextColor="grey" />
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#e5e5e5', width: '90%', borderRadius: 10, marginHorizontal: 20, marginHorizontal: 20, marginTop: 20, }}>
            <TextInput placeholder='Confirm Password' style={styles.mypassword}  onChangeText={setPassword}  onEndEditing={ValidatePassword} placeholderTextColor="grey" 
           secureTextEntry={hidePass ? true : false}
           >
          ...
          <View style={styles.btn} >
            ...
            }} style={{ fontFamily: 'OpenSans-Bold', color: '#fff', letterSpacing: .6, textAlign: 'center', width: '100%' }} >Signup Here</Text>
          </View>
          ...
          <View>
            <Text style={{ color: 'grey', textAlign: 'center', marginTop: 40, fontFamily: 'OpenSans-Bold' }}>Already Have an account : <Text style={{ color: '#4eb6aa', fontSize: 16 }} onPress={()=> navigation.navigate('Signin')}>Sign In</Text> </Text>
          </View>
        </View>
